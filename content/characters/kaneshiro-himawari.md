...
| **髪** | 黒髪のショートヘア。少し丸みのあるカット。水泳で濡れても崩れない実用的な長さ |
| **目** | 大きく明るい瞳。表情変化が豊か |
| **顔立ち** | 太陽のように明るい笑顔 |
| **赤面・生理表現** | 耳たぶから首筋、胸元まで**鮮血のように大赤面**する |

> [!warning] 顔のモデル未定
> 4人中、唯一モデルの指定がない。楓（小西真奈美風）、柊（當真あみ）、桃香（`image-29.png`）に対し、向日葵だけ基準がないため**記述の解像度が落ちている**。イルカのモチーフ（丸みのある額、常に笑っているような口角）から詰めるのが手掛かりになる。
