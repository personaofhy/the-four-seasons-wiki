...
> [!warning] 画風路線は封印済み — 本ノートは技術的教訓のためだけに残している
> 本文中の「ドット絵」「PC-98」「16ビットピクセルアート」は、**撤回された旧路線**の記述。
> **画風の指針として読まないこと。**
> 一方、IP-Adapter＋ControlNetによる同一性維持の知見（1〜2章・4章）は現在も有効。そこだけを参照する。
...
![[髪型は短め、さらに短くてもいいくらい、春らしいやや明るい茶色.jpg]]
