...
outfit_name: 普段着
# --- 4人横断の対比軸（必須・空欄禁止）---------------------------------
# 該当なしの場合も "なし" と書くこと。空欄だと「書き忘れ」と「意図的な不在」が区別できない。
agency_shoes: 靴が示す自己決定の度合い（例：紐＝能動／マジックテープ＝決定の拒絶）
breakdown_nature: 作為 | 偶然 | 暴力 | 自発 のいずれか
underwear_progression: 段階を ➔ で連結（例：レース ➔ パッド ➔ おむつ）／変遷しない場合は なし
# ----------------------------------------------------------------------
