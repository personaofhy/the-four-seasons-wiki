...
quirk: 寒がりで腹巻き愛用
animal_motif: 鶯（春の小鳥）
face_model: assets/boards/image-29.png がイメージに近い（もう少し個性が必要）
...
| **髪** | 明るいブラウンベージュのショートボブ。毛先が軽く外へ跳ね、シースルー気味の前髪。額が自然に見えるすっきりとした形 |
| **輪郭** | 丸みのある小さめの顔。顎は細い |
| **眉** | 細めのアーチ。知的で柔らかい |
| **目** | やや切れ長で涼しげ。明るく温かみのあるブラウンの瞳 |
...
> [!note] 顔のモデル
> `assets/boards/image-29.png` がイメージに近い。ただし**もう少し個性が必要**で、鶯のモチーフ（小さく丸い目、首をかしげる仕草、澄んだ声）を足す方向で詰める。
